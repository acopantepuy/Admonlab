...
*/	
	...
	if (isset($_SESSION['UserAdmonLab'])){ //Validar Login Correcto
		...
		print '<div class="container">';
	        	print '<table id = "tipoClienteTabla" class="table table-bordered table-hover" 
	        			data-search="true" 
	        			...
	        			data-url="data.tipo.clientes.php">';
					
					print '<thead>';
						print '<tr>';
							print '<th data-field="SRC_TYPE_CUSTOMER_ID" data-sortable ="true">Código</th>';
		...
		include_once("frm/frm_tipo_clientes.php");// Ventana para modificar u añadir un nuevo registro
...
<script src="js/admonlab.save.tipo.clientes.js"></script>