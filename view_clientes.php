...
*/	
	...
	if (isset($_SESSION['UserAdmonLab'])){ //Validar Login Correcto
		...
		print '<div class="container">';
	        	print '<table id = "ClienteTabla" class="table table-bordered table-hover" 
	        			data-search="true" 
	        			...
	        			data-url="data.clientes.php">';
					
					print '<thead>';
						print '<tr>';
							print '<th data-field="SRC_CUSTOMER_ID" data-sortable ="true">Código</th>';
							print '<th data-field="SRC_TYPE_CUSTOMER" data-sortable ="true">Tipo Cliente</th>';
							print '<th data-field="SRC_NAME" data-sortable ="true">Razón Social</th>';
							print '<th data-field="SRC_RIF" data-sortable ="true">RIF</th>';
							print '<th data-field="SRC_MAIL" data-sortable ="true">Correo</th>';
							print '<th data-field="SRC_CONTACT" data-sortable ="true">Contacto</th>';
		...
		include_once("frm/frm_clientes.php");// Ventana para modificar u añadir un nuevo registro
...
<script src="js/admonlab.save.clientes.js"></script>